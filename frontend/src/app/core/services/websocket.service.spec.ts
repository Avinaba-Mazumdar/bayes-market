...
describe('WebSocketService', () => {
    ...
    it('should update signals on incoming messages when not paused', () => {
        ...
        (service as unknown as { handleIncomingMessage: (raw: string) => void }).handleIncomingMessage(JSON.stringify(mockPriceUpdate));
        ...
        (service as unknown as { handleIncomingMessage: (raw: string) => void }).handleIncomingMessage(JSON.stringify(mockTrade));
